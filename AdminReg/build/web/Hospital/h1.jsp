 ...
 <%
    ...
    else
    {
        try
        {
            ...
            if(ut.equalsIgnoreCase("hospital")==false)
            {
                response.sendRedirect("../AuthorizationError.jsp");
            }
        }
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
            <li class="nav-link scrollto" href="#Home">Home</li>
            <li class="dropdown"><a href="#"><span>Doctor</span></a>
                  <ul>
                      <li><a class="nav-link scrollto " href="DoctorReg.jsp">New Doctor</a></li>
                      <li><a class="nav-link scrollto" href="ShowDoctor.jsp">Show Doctor</a></li>
                      <li><a class="nav-link scrollto" href="Profile.jsp">Doctor Profile</a></li>
                      <li><a class="nav-link scrollto" href="DoctorDelete.jsp">Delete Doctor</a></li>
                  </ul> 
            </li>
  ...
  <div class="hos" style="margin:350px;">
</div>
