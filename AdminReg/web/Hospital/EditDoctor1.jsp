...
<h1>Update Doctor</h1>
   ...
   if(d7==null) d7="no"; else d7="yes";
    ...
    Connection cn=obj.createConnection();
                ...
                String s1="update doctordata set dname=?,dcontact=?,daddress=?,specialisation=?,qualification=?,timings=?,monday=?,tuesday=?,wednesday=?,thrusday=?,friday=?,saturday=?,sunday=? where demail=?";
