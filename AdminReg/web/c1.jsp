...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul >
            ...
            <li> <a href="showshop1.jsp" > <i style='font-size:24px' class='fas'>&#xf469;</i>Medical Store</a>
  ...
  <div class="row" style="min-height: 600px; min-height: 600px; margin: 250px 0px 0px 50px;">