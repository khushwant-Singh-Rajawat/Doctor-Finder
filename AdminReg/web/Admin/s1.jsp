    ...
    else
    {
        try
        {
            ...
            ut=session.getAttribute("usertype").toString();
             if(ut.equalsIgnoreCase("MedicalShop"))
            {
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
            ...
            <li><a class="nav-link scrollto" href="MedicalShop_Home.jsp">Home</a></li>
            ...
            <li class="dropdown"><a href="#"><span>Medical Shop</span></a>
                  <ul>
                      ...
                      <li><a class="nav-link scrollto" href="ShopProfile.jsp">Medical Profile</a></li>
                      
                  </ul> 
            </li>
 
            <li class="dropdown"><a href="#"><span>Medicine</span></a>
                  <ul>
                      <li><a class="nav-link scrollto" href="../Medicine/MedReg.jsp">Add Medicine</a></li>
                      <li><a class="nav-link scrollto" href="../Medicine/showmedicine.jsp">Show Medicine</a></li>
          
                  </ul> 
            </li>
     
            <li><a class="nav-link scrollto" href="ShopChangePass.jsp">Change Password</a></li>
