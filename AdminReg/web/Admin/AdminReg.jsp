...
<form onSubmit="return A()" method="post" action="AdminReg1.jsp">
    <p>Name<input type="text" name="T1" id="txt1"/><span id="sp1"></span></p>
<p>Address<input type="text" name="T2" id="txt2"/><span id="sp2"></span></p>
<p>Contact<input type="text" name="T3" id="txt3"/><span id="sp3"></span></p>
<p>Email<input type="text" name="T4" id="txt4" placeholder="Enter email"/><span id="sp4"></span></p>
<p>Password<input type="password" name="T5" id="txt5"/><span id="sp5"></span></p>
<p>Confirm Password<input name="T6" type="password" id="txt6"/><span id="sp6"></span></p>
